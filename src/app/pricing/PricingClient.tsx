              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={
                      isLoading || isCurrent || loading || subscriptionLoading
                    }
                    className={cn(
            ...
            <div className="relative z-10 grid gap-8 px-6 py-8 lg:grid-cols-[1.2fr_0.9fr] lg:px-8 lg:py-10">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/65 md:text-base">
                  Buy one-time credit packs whenever you need extra output. Your
                  monthly subscription credits still reset normally, while
